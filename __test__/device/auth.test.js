...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Jessika92',
      password: '_KQzKJGcFp_AbrK',
      email: 'Charity_Christiansen@yahoo.com',
      name: 'Stuart O\'Kon',
      userType: 402,
      mobileNo: '1-367-643-4193 x713',
      resetPasswordLink: {},
      loginRetryLimit: 141,
      loginReactiveTime: '2023-02-21T21:13:18.159Z',
      id: '623d7c56ebd1755684ed5afb'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Joany_Lubowitz45',
        'password':'GrWFNTH9MSLNAVl',
        'email':'Ashton_Ledner74@gmail.com',
        'name':'Bernadette Stokes',
        'userType':authConstant.USER_TYPES.User,
        'mobileNo':'383-646-6003',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    ...
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Ashton_Ledner74@gmail.com', });
