...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Bill.Steuber74',
      password: '56hs6UEV_QKCSt6',
      email: 'Juston.Boyer@hotmail.com',
      name: 'Adrienne Connelly',
      userType: 35,
      mobileNo: '1-665-477-3609 x8850',
      resetPasswordLink: {},
      loginRetryLimit: 723,
      loginReactiveTime: '2022-09-04T04:57:11.416Z',
      id: '623d7c56ebd1755684ed5ad7'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Bradly_Hammes26',
        'password':'g8eJ85FxPCjnwnX',
        'email':'Lavon.Hoeger@hotmail.com',
        'name':'Jenna Spinka',
        'userType':authConstant.USER_TYPES.Admin,
        'mobileNo':'(560) 446-5737 x927',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    ...
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Lavon.Hoeger@hotmail.com', });
